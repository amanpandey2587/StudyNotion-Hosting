...
export function updateDisplayPicture(token, formData){
    return async (dispatch)=>{
        ...
        try{
            ...
            console.log("UPDATE_DISPLAY_API RESPONSE",response)
            if(!response.data.success){
                throw new Error(response.data.message)
            }
            toast.success("Display Pictuer Updated Successfully ")
            dispatch(setUser(response.data.data))
        }catch(error){
            console.log("UPDATE_DISPLAY _PICTURE _API ERROR",error.message)
...
export function updateProfile(token,formData){
    return async (dispatch)=>{
        ...
        try{
            ...
            console.log("Update_profile_api error",error.message)
...
export async function changePassword(token,formData){
    ...
    try{
        ...
        console.log("Change_password_api error",error.message)
...
export function deleteProfile(token,navigate){
    return async(dispatch)=>{
        ...
        try{
            ...
            console.log("Delete_profile_api error...",error.message)
