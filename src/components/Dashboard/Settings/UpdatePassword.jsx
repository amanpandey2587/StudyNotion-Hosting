...
export default function UpdatePassword(){
    ...
    return (
        ...
        <form onSubmit={handleSubmit(submitPasswordForm)}> 
            <div className="my-10 flex flex-col gap-y-6 rounded-md border-[1px] border-richblack-700 b-richblack-800 p-8 px-12    ">
            <h2 className="text-lg font-semibold text-richblack-5  ">Password</h2>
                <div className="flex flex-col gap-5 lg:flex-row ">
                    <div className='relative flex flex-col gap-2 lg:w-[48%] ' >
                        <label htmlFor="oldPassword" className="label-style text-richblack-400 " >
                            Current Password
                        </label>
                        <input
                    ...
                    <div className='relative flex flex-col gap-2 lg:w-[48%] ' >
                        <label htmlFor="newPassword" className="label-style text-richblack-400" >
                            New Password
                        </label>
                        <input
