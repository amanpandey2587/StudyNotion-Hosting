  ...
  return (
    ...
    <div className= "">
        ...
        <section className=" bg-richblack-700  ">
            <div className="relative mx-auto flex w-11/12 max-w-maxContent flex-col justify-between gap-10 text-center text-white " >
                <header className=" mx-auto py-20 text-4xl font-semibold lg:w-[70%] ">
                    ...
                    <HighlightText text={" Brighter Future"} color="#B3F4FF"  />
                    <p className=" mx-auto mt-3 text-center text-base font-medium text-richblack-300 lg:w-[95%] "  >
                    Studysync is at the forefront of driving innovation in online education. We're passionate about creating a brighter future by offering cutting-edge courses, leveraging emerging technologies, and nurturing a vibrant learning community.
                    </p>
                </header>
        ...
        <section className="border-b border-richblack-700">
            <div className='mx-auto flex w-11/12 max-w-maxContent flex-col jsutify-between gap-10 text-richblack-500 '>
        ...
        <section>
            <div  className='mx-auto flex w-11/12 max-w-maxContent flex-col justify-between gap-10 text-richblack-500 '>
                ...
                <div className=" flex flex-col items-center gap-10 lg:flex-row justify-between ">
                    ...
                    <div>
                        <img src={FoundingStory} alt='foundingStoryPage' className="shadow-[0_0_20px_0] shadow-[#fc6767] " />
                    </div>
                </div>
